...
/***/ function(module, exports, __webpack_require__) {
	...
	var Content = _router2.default.route(document.location);

	function App(props) {
	  return _react2.default.createElement(Content, props);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Edit = __webpack_require__(166);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var realtimeUtils = new utils.RealtimeUtils({ clientId: ("419471180572-fq6ou93t5gun5kd0dr1irjjev3ij5vd3.apps.googleusercontent.com") });

	var RENDER_DEDLAY = 1000; // ms
	...
	var Edit = function (_React$Component) {
	  ...
	  function Edit(props) {
	    ...
	    realtimeUtils.authorize(function (res) {
	      return res.error ? _this.showAuthButton() : _this.startRealtime();
	    });
	    _this.state = {
	      id: null,
	      loading: true,
	  ...
	  _createClass(Edit, [{
	    ...
	    value: function render() {
	      ...
	      if (this.state.showAuthButton) {
	        return _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'button',
	            { type: 'button', onClick: this.authorize.bind(this) },
	            'Authorize'
	          )
	        );
	      }
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'ul',
	          null,
	          this.state.collaborators.map(function (collaborator) {
	            return _react2.default.createElement(
	              'li',
	        ...
	        _react2.default.createElement('textarea', { ref: 'text', onChange: this.textChanged.bind(this) }),
	        _react2.default.createElement('div', { dangerouslySetInnerHTML: { __html: this.state.html } })
	      );
	    }
	  }, {
	    key: 'showAuthButton',
	    value: function showAuthButton() {
	    ...
	    value: function authorize() {
	      ...
	      realtimeUtils.authorize(function (res) {
	        return res.error ? _this2.showAuthButton() : _this2.startRealtime();
	      }, true);
	    }
	  }, {
	    key: 'startRealtime',
	    value: function startRealtime() {
	      ...
	      if (id) {
	        ...
	        realtimeUtils.createRealtimeFile('1MINUTES Markdown', function (createResponse) {
	          window.history.pushState(null, null, '?id=' + createResponse.id);
	          realtimeUtils.load(createResponse.id, _this3.onFileLoaded.bind(_this3), _this3.onFileInitialize.bind(_this3));
	          _this3.setState({ id: createResponse.id });
	        });
	      }
	    }
	    ...
	    value: function onFileLoaded(doc) {
	      ...
	      this.setState({
	        loading: false,
	        showAuthButton: false,
	        html: (0, _marked2.default)(collaborativeString.getText()),
	        collaborators: doc.getCollaborators()
	      }, function () {
	        return _this4.wireTextBoxes(collaborativeString);
	      });

	      // 参加者が増減したときの処理
	      doc.addEventListener(gapi.drive.realtime.EventType.COLLABORATOR_JOINED, function (event) {
	        _this4.setState({ collaborators: _this4.state.collaborators.concat(event.collaborator) });
	      });
	      doc.addEventListener(gapi.drive.realtime.EventType.COLLABORATOR_LEFT, function (event) {
	        _this4.setState({ collaborators: _this4.state.collaborators.filter(function (c) {
	            return c.userId !== event.collaborator.userId;
	          }) });
	      });
	    }
	    ...
	    key: 'wireTextBoxes',
	    value: function wireTextBoxes(collaborativeString) {
	      var textNode = _reactDom2.default.findDOMNode(this.refs.text);
	    ...
	    value: function textChanged(event) {
	      ...
	      var timerId = window.setTimeout(function () {
	        var text = _reactDom2.default.findDOMNode(_this5.refs.text).value;
	        _this5.setState({ delayTimerId: null, html: (0, _marked2.default)(text) });
	      }, RENDER_DEDLAY);
